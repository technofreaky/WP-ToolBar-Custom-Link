<div class="wrap">
    ...
    <h2>WP ToolBar Custom Link</h2>
    <p> Thanks for download this plugin. kindly subscribe for mailing list to keep updated about our new plugin, plugin release. and more.</p>
...
<div id="poststuff">
    <div id="postbox-container-1" class="postbox-container">
        <div class="postbox">
            ...
            <h3 class="hndle"><span><?php _e('Subscribe to our mailing list'); ?></span></h3> 
            <div class="option">
                    ...
                    <form action="http://varunsridharan.us11.list-manage.com/subscribe/post?u=438373310b9f3b6302526f737&amp;id=71f582aed1" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                        <div id="mc_embed_signup_scroll"> 
                            ...
                            <div class="mc-field-group">
                                <label for="mce-EMAIL"><?php _e('Email Address'); ?>  <span class="asterisk">*</span>
                                </label>
                                <input type="email" value="<?php echo get_option('admin_email'); ?>" name="EMAIL" class="required email" id="mce-EMAIL">
                            </div>
                            <div class="mc-field-group">
                                <label for="mce-FNAME"><?php _e('First Name'); ?> <span class="asterisk">*</span>
                                </label>
                                <input type="text" value="" name="FNAME" class="required" id="mce-FNAME">
                            </div>
                            <div class="mc-field-group">
                                <label for="mce-LNAME"><?php _e('Last Name'); ?> </label>
                                <input type="text" value="" name="LNAME" class="" id="mce-LNAME">
                            </div>
                            <div class="mc-field-group">
                                <label for="mce-WEBSITE"><?php _e('Website'); ?> <span class="asterisk">*</span>
                                </label>
                                <input type="url" value="<?php echo get_site_url(); ?>" name="WEBSITE" class="required url" id="mce-WEBSITE">
                            </div>
                            <div class="mc-field-group">
                                <label for="mce-COUNTRY"><?php _e('Country'); ?> <span class="asterisk">*</span>
                                </label>
